...
//     if (!isMatch) {
//       // console.log('code  chal raha hai kya');
...
//         const { classRoomId, status } = pendingRequests[i];
//         const classinfo = await Classroom.findById({ _id: classRoomId });
//         console.log("Hello i am here")
//         // const classinfo = await Classroom.findById(classId).populate('topics');
//         if (classinfo != null) {
//           const classData = {
//             classID: classinfo._id,
//             title: classinfo.title,
...
//             topics: classinfo.topics.map(topic => ({ id: topic._id, name: topic.name }))
//           };
//           console.log("ClassData from backend: ",classData);
//           classroom.push(classData);
//         }
//       }
//     }
...
//           subject: classinfo.subject,
//           members: classinfo.members.length,
//           chapters: chapterTitles // this will include chapter titles
//         };
...
//     //   const classinfo = await Classroom.findById(classId)
//     //   .populate({
//     //     path: 'curriculum_Structure',  // First, populate the curriculum structure
//     //     populate: {
//     //       path: 'chapters',  // Then, populate the chapters inside curriculum structure
//     //       populate: {
//     //         path: 'resources.notes',  // Populate notes array inside resources for each chapter
//     //       }
//     //     }
//     //   });
